...
lifedata <- read.table(file.choose("Lab 3 - Importing Data, Graphing, and Basic Analysis/data/TimeInLifeData.txt"), sep="\t", header=FALSE, stringsAsFactors = T)
...
summary(lifedata)
lifedata[rowSums(is.na(lifedata)) > 0,]
lifedata$bodytemp[is.na(lifedata$bodytemp)] <- median(lifedata$bodytemp, na.rm = TRUE) # making all 0's the mean

outs <- boxplot.stats(lifedata$bodytemp)$out #finds the outlier
...
summary(lifedata)
lifedata <- droplevels(lifedata, exclude = "") #exclude any empty string element 
summary(lifedata)
...
## Change these file directories to location of your output folder for lab 3!!
      ###This command opens a PDF device, which means that any plots created after this
          #line will be saved to a file named convars.pdf in the specified directory 

pdf(file="Lab 3 - Importing Data, Graphing, and Basic Analysis/output/convars.pdf")
sink("Lab 3 - Importing Data, Graphing, and Basic Analysis/output/convars.txt")
...
#pdf(file="Lab 3 - Importing Data, Graphing, and Basic Analysis/output/age.pdf")
#sink("Lab 3 - Importing Data, Graphing, and Basic Analysis/output/age.txt")


par(mfrow=c(1,2))

## Create histogram of dependent variable (the difference measure)
hist(lifedata$age, xlab="Age", main=NA, col="skyblue")
...
boxplot(lifedata$age, ylab="Age", main=NA, 
        col="skyblue")
...
## Set up storage of all following figures in a pdf doc and tabular info in a text file
## Change these file directories to location of your output folder for lab 3!!!
#pdf(file="Lab 3 - Importing Data, Graphing, and Basic Analysis/output/catvars.pdf")
#sink("Lab 3 - Importing Data, Graphing, and Basic Analysis/output/catvars.txt")
...
## Set up storage of all following figures in a pdf doc and tabular info in a text file
## Change these file directories to location of your output folder for lab 3!!!
#pdf(file="Lab 3 - Importing Data, Graphing, and Basic Analysis/output/catvarstats.pdf")
#sink("Lab 3 - Importing Data, Graphing, and Basic Analysis/output/catvarstats.txt")
...
#pdf(file="Lab 3 - Importing Data, Graphing, and Basic Analysis/output/convarscatter.pdf")
## Set up graphics device to display a 2 row by 3 column configuration of plots
par(mfrow=c(2, 3))
...
## Set up storage of all following figures in a pdf doc and tabular info in a text file
## Change these file directories to location of your output folder for lab 3!!!
pdf(file="Lab 3 - Importing Data, Graphing, and Basic Analysis/output/convarstats.pdf")
sink("Lab 3 - Importing Data, Graphing, and Basic Analysis/output/convarstats.txt")
